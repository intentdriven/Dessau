...
func TestOnlyAFatalTracebackLineIsReadAsALoadFailure(t *testing.T) {
	cases := []struct {
		...
		{"a path with spaces in it", "Traceback (most recent call last):\nValueError: cannot open /Users/alice/Secret Project/weights file.safetensors here\n",
			"ValueError: cannot open <path> file.safetensors here"},
		{"control characters", "Traceback (most recent call last):\nValueError: \x1b[31mred\x1b[0m\x07 text\n",
			"ValueError: [31mred[0m text"},
		{"a stray line after a survived traceback", "Traceback (most recent call last):\n  File \"x.py\"\nBrokenPipeError: gone\n2026-09-21 - INFO - carried on\nValueError: not a traceback line at all\n", ""},
		{"a survived traceback then a fatal one", "Traceback (most recent call last):\n  File \"x.py\"\nBrokenPipeError: gone\n2026-09-21 - INFO - carried on\nTraceback (most recent call last):\n  File \"y.py\", line 1\n    raise ValueError(msg)\nValueError: Model type x not supported.\n",
			"ValueError: Model type x not supported."},
		{"a terminal line still being written", "Traceback (most recent call last):\n  File \"x.py\"\nValueError: Model ty", ""},
