...
// Foundation Models framework, and a Dessau server over its OpenAI-compatible
...
// MARK: - A Dessau server

/// The OpenAI-compatible streaming endpoint a Dessau server exposes.
