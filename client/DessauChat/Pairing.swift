...
// MARK: - Pairing
//
// Pairing gives this client an identity of its own on one Dessau server
...
enum PairingStore {
    ...
    nonisolated private static let keyTag = Data("sh.intentdriven.dessau.chat.pairing".utf8)
    ...
    nonisolated private static let logger = Logger(subsystem: "sh.intentdriven.dessau.chat", category: "pairing")
