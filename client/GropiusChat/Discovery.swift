// Finding Gropius servers on the local network: the service type, what a
...
final class ServiceResolver {
    ...
    private let queue = DispatchQueue(label: "dev.gropius.chat.resolve")
...
private nonisolated func gropiusResolveReply(
