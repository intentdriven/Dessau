...
found_at: ".abcd/development/intents/shipped/itd-2609180959397172-bob-messages-gropius-from-discord-alice-pastes-a-discord-bot.md"
wontfix_reason: "the shipped intent is not edited and the verdict not re-ingested; the intended behaviour and the owed test and docs sentence are iss-2609201007355356 (maintainer, 2026-09-20)"
---
...
- declined: the shipped intent is not edited and the verdict not re-ingested; the intended behaviour and the owed test and docs sentence are iss-2609201007355356 (maintainer, 2026-09-20)
