...
wontfix_reason: "The narrowing is deliberate and recorded in the intent's Audit Notes and the 2026-09-19 decision lines: the plain port's byte-for-byte promise is held by the replay fixture set, and the scope condition's wider wording is what the record now qualifies rather than a promise to change the code."
---
...
- declined: The narrowing is deliberate and recorded in the intent's Audit Notes and the 2026-09-19 decision lines: the plain port's byte-for-byte promise is held by the replay fixture set, and the scope condition's wider wording is what the record now qualifies rather than a promise to change the code.
