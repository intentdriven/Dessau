...
deferred_after: "v0.8.1"
deferral_reason: "Re-deferred at the 0.8.1 cut: a client appearance defect (System to Dark to System leaves Settings dark) found in the maintainer's manual test; the maintainer tests by hand against this release, and the fix is next up in the client lanes; recorded here rather than stepped over."
---
