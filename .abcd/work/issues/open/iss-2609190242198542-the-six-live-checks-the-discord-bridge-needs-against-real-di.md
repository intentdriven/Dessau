...
deferral_reason: "Re-deferred at the 0.8.1 cut: the six live Discord checks need the maintainer's hand and a real Discord server; the maintainer tests by hand against this release; recorded here rather than stepped over."
---
