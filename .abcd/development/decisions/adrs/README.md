...
| [adr-2609081118587999](2609081118587999-detecting-a-private-network-daemon-may-inform-what-dessau-s.md) | Detecting a private-network daemon may inform what Dessau says, never what it enforces | superseded by [adr-2609111126115848](2609111126115848-a-deliberately-invoked-diagnostic-may-report-an-observed-sig.md) on the diagnostic carve-out | 2026-09-08 |
...
| [adr-2609091123526871](2609091123526871-dessau-binds-loopback-alongside-every-other-address-with-a-p.md) | Dessau binds loopback alongside every other address, with a private-network mode that fails closed to loopback | accepted | 2026-09-09 |
