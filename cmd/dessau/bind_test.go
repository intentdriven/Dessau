...
// on this Mac: Dessau serves loopback, says which address it dropped, and does
...
// Criterion 8 of the private-network intent: Dessau does not advertise to
...
// state Dessau owns.
func TestWhatDessauAdvertisesItselfOn(t *testing.T) {
...
//
// Without the second half it narrowed in silence. A name is a bind Dessau
